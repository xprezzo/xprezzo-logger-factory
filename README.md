...
The function returned from `loggerFactory.compile` takes three arguments `tokens`, `req`, and
...
The `loggerFactory` middleware can be used as many times as needed, enabling
combinations like:
